...
//     mockIdGenerator.generate.mockReturnValueOnce('new_order_id'); // Gera orderId
...
const orderBusiness = new OrderBusiness(
  mockOrderDatabase as unknown as OrderDatabase,
  mockProductDatabase as unknown as ProductDatabase,
  {} as any, // UserDatabase não é necessário para createOrder
  mockIdGenerator as unknown as IdGenerator,
  {} as any,
  {} as any,
  {} as any
...
describe('OrderBusiness - createOrder', () => {
  ...
  test('should successfully create an order with valid items', async () => {
    ...
    mockIdGenerator.generate.mockReturnValueOnce('order_id').mockReturnValueOnce('item_id_1').mockReturnValueOnce('item_id_2');
    mockProductDatabase.findPureProductById.mockResolvedValueOnce(validProduct1).mockResolvedValueOnce(validProduct2);
    ...
    expect(result).toEqual({
      ...
      order: {
        ...
        total: 100,
        items: [
          { itemId: 'product_id_1', productId: 'product_id_1', quantity: 2, price: 50 },
          { itemId: 'product_id_2', productId: 'product_id_2', quantity: 1, price: 50 },
        ],
      },
    });
  ...
  test('should create an order with valid items and skip invalid ones', async () => {
    ...
    mockIdGenerator.generate.mockReturnValueOnce('order_id').mockReturnValueOnce('item_id_2');
    mockProductDatabase.findPureProductById.mockResolvedValueOnce(null).mockResolvedValueOnce(validProduct2);
